package tests.day18htmlReports;
...
public class C01_HTML_Reports extends TestBaseRapor {
    //TestNGden direkt rapor alamıyoruz. İlla almak istiyorsak extentreport kütüphanesini dosyamıza ekledik.
    // bu şekilde onu kullanarak rapor oluşturabiliyoruz. Rapor oluşturabilmek için de önce html raporu  kendi ellerimizle
    //oluşturmamız gerekiyor.(Aşağıda infolarla oluşturduğumuz durumlar)
